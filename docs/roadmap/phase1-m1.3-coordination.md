...
**M1.2 reference**: `docs/handoffs/2026-06-m1.2-@304-extra-stream-classification.md` (finalized, now refs full) + `Exports/phase1-m1.2-@304-analysis-initial.*` + full N=10 `phase1-m1.2-@304-analysis-full.*` (subagent 019e86ea-60a1...) + matrix.
