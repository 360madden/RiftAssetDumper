...
- The practical 350 + texture fallbacks combined-package report/Markdown now explicitly lists practical source substitutions, texture fallbacks, neutral review materials, and an import-review checklist: 1 non-durable source substitution, 1 texture-fallback entry, 2 non-durable texture fallback refs, and 13 non-durable neutral review materials in `Assets/build/flythrough/combined-obj-package-practical-350-texture-fallbacks/COMBINED_OBJ_PACKAGE.md`.
- Practical 350 + texture fallbacks gallery: `Assets/build/flythrough/texture-triage-gallery-practical-350-texture-fallbacks/index.html` renders 350 materialized cards, 0 remaining rows, explicit practical source substitution / texture fallback tables containing row 121 and row 118, plus neutral review-material swatches/counts for the 13 remaining texture gaps.
- One-command rebuild: `python scripts/build_flythrough_practical_package.py` regenerates source substitutions, texture fallbacks, the 350-row manifest/CSV, per-row OBJ/MTL bundle, smoke report, combined OBJ package, gallery, a focused texture-gap report, unresolved texture evidence, and `Assets/build/flythrough/evidence/practical-350-texture-fallbacks/practical-package-build-report.json`; latest summary is 350/350 materializable, 1 source substitution, 2 texture fallback refs, 13 neutral material rows, 13 color-coded review materials, 2 unmatched exact DDS refs, 0 exact local matches for those DDS refs, 0 neutral asset IDs with texture-link rows, bundle=True, smoke=True, combined=350, skipped=0, gallery=True.
...
- Unresolved texture evidence report: `Assets/build/flythrough/evidence/practical-350-texture-fallbacks/UNRESOLVED_TEXTURE_EVIDENCE.md` and `unresolved-texture-evidence-report.json` scan `nif-reference-name-matches`, `nif-texture-links`, and `live-texture-links-all4`; current result is 0 exact local matches for the 2 Eternal Assault flower DDS refs and 0 texture-link rows for the 5 neutral asset IDs.
