...
| **6** | NM-6 M6.1 batch navmesh generation | `build_all_navmeshes.py` orchestrates extract→build→validate per zone, fail-isolated. `navmesh-index-v1` schema with M6.2 adjacency + M6.3 cross-zone routing hooks. REAL batch on `ep1.world_objects.dungeons` PASSES (9 polys / 9 walkable). 1227/1230 pytest + 3 deliberate skips. | SHIPPED 2026-07-12 | [`2026-07-12-nm-6-m6.1-batch-navmesh.md`](2026-07-12-nm-6-m6.1-batch-navmesh.md) | [`2026-07-12-nm-6-m6.1-batch-navmesh-compact.md`](2026-07-12-nm-6-m6.1-batch-navmesh-compact.md) (TL;DR — fast context resumption) |
...
- **Cycle 6 (NM-6)**: M6.1 batch navmesh — full design handoff `2026-07-12-nm-6-m6.1-batch-navmesh.md`; compact TL;DR companion `2026-07-12-nm-6-m6.1-batch-navmesh-compact.md`.
