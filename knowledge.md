...
- **meshSize=297 TEXCOORD discovery** (2026-06-18): Residual stream at offset=24, labeled TEXCOORD by the string heuristic, proved to be `float32xvec3` position/normal/UV vertex data (648 bytes = 54 vertices × 12 bytes/vert). 8/9 batch export succeeded (14 OBJs total, 15,315 vertices, 15,309 faces, 0 structural issues). 3 single-mesh assets at 60 faces each; 1 multi-mesh asset (`9f32d26c425ed264`) with **6 mesh blocks** (#6, #27, #45, #59, #76, #90) totaling 14,886v/14,874f — including block #27 at 12,993v/12,991f, the largest single-block export in the project. 5 small assets at 2 faces each. 10 unique IdPrefixes, 374 mesh blocks in family. OBJs at `Exports/discovery-plan/mesh297-probe/`.
- **meshSize=305 glow misclassification** (2026-06-18): Offset=0 stream labeled "glow" (plausible=0.9487) decoded but geometrically degenerate — all vertices at (0,0,1), confirmed as glow sprite/billboard effect, not usable geometry.
