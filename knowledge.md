...
- **meshSize=297 TEXCOORD discovery** (2026-06-18): Residual stream at offset=24, labeled TEXCOORD by the string heuristic, proved to be `float32xvec3` position/normal/UV vertex data (648 bytes = 54 vertices × 12 bytes/vert). 8/9 batch export succeeded (9 OBJs total, 429 vertices, 435 faces, 0 structural issues). 3 meshes at 60 faces, 1 large mesh at 245 faces (`9f32d26c425ed264`), 5 small at 2 faces. 10 unique IdPrefixes, 374 mesh blocks in the untapped family. OBJs at `Exports/discovery-plan/mesh297-probe/`.
