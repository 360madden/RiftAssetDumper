...
- **M1.2 (@304 extra stream classification on mesh#34)** — ✅ COMPLETE. Builds on M1.1 matrix. Handoff: `docs/handoffs/draft-2026-06-m1.2-@304-extra-stream-classification.md`. Uses M1.1 `IDsCovered` as controlled target list. 10/10 scoped classification, 12/12 matrix patterns confirmed.
