...
The current Ghidra pairing promotion checklist is tracked in `docs/ghidra-pairing-promotion-checklist.md`; the review-report schema is `docs/schemas/ghidra-pairing-review-v1.schema.json`, the review-rank probe manifest schema is `docs/schemas/ghidra-review-rank-probes-manifest-v1.schema.json`, the review-rank summary schema is `docs/schemas/ghidra-review-rank-probes-summary-v1.schema.json`, and the grouped attribute-candidate report schema is `docs/schemas/ghidra-attribute-candidate-v1.schema.json`.
